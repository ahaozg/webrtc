...
export const RoomErrorMessage = {
  ...
  CAMERA_MIC_IN_USER: '暂时无法访问摄像头/麦克风，请确保当前没有其他应用请求访问摄像头/麦克风，并重试',
  NOT_FOUND_MIC_ERROR: '当前设备没有麦克风',
  MIC_USER_DENY: '用户拒绝/取消麦克风授权',
  MIC_IN_USER: '暂时无法访问麦克风，请确保当前没有其他应用请求访问麦克风，并重试',
  NOT_FOUND_CAMERA_ERROR: '当前设备没有相机',
  CAMERA_USER_DENY: '用户拒绝/取消相机授权',
  CAMERA_IN_USER: '暂时无法访问摄像头，请确保当前没有其他应用请求访问摄像头，并重试',
